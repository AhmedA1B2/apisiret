...
$stmt = $con->prepare("INSERT INTO `student`( `name`, `num`, `pass`,`mo`,`tq`,`college`,`tkss`,`time`,`who_added`) VALUES (?,?,?,?,?,?,?,?,?)");

$stmt -> execute(array($name,$num,$pass,$mo,$tq,$college,$tkss,$time,$who_added));
